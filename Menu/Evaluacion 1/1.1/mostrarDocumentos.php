    ...
    if ($idDocente) {
        ...
        if ($result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                // Ajustar ruta relativa para que sea accesible desde el navegador
                $rutaBase = "/ruta/desde/la/raiz/public"; // Ajusta esto a tu configuración
                $rutaWeb = str_replace('../../../', $rutaBase . '/', $rutaArchivo);
                ...
                echo "<a href='$rutaWeb' class='btn btn-sm btn-secondary me-2' target='_blank'>Ver</a>";
                
                // Botón para descargar el archivo
                echo "<a href='$rutaWeb' class='btn btn-sm btn-primary me-2' download>Descargar</a>";
                
                // Botón para eliminar el archivo
                echo "<button class='btn btn-sm btn-danger' onclick='eliminarArchivo($idDocumento, \"$rutaWeb\")'>Eliminar</button>";
